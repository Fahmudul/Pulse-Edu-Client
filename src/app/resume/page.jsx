...
const about = {
  title: "About Me",
  description:
    "I began coding in 2020, mastering the basics and OOP in C and C++, and tackling problem-solving tasks. I then specialized in Python, working on advanced projects and DSA. At the end of 2023, I transitioned to web development and now thrive as a junior MERN stack developer.",
  info: [
    {
      sectionName: "Name",
                  ...
                  {about.info.map((info, index) => (
                    ...
                    >
                      ...
                      <Link
                        ...
                        className={index !== 3 ? "hidden" : "text-xl text-white/60"}
                      >
                        {info.info}
                      </Link>
