...
export default function TeacherAvailabilityForm({
  ...
  return (
    <div className="max-w-lg mx-auto  bg-white dark:bg-gray-800 shadow-2xl rounded-xl overflow-hidden border border-primary dark:border-gray-700">
      {/* Modal Header */}
      <div className="bg-primaryPro text-primary p-5 flex justify-between items-center">
        ...
        <div className="p-1 bg-[#E8F6F3] rounded-full h-8 w-8 flex items-center justify-center cursor-pointer">
          <span className="text-[#093B3B] font-bold">&times;</span>
        </div>
      </div>
